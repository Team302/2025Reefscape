...
// @Modifications from generated file
// 1) Add namespace for classes based on the robot, so Chassis9997 for this one
// 2) Fix invalid values

namespace Chassis9997
{
    ...
    public:
        ...
        // This needs to be tuned to your individual robot
        // @Modifications invalid value replaced
        static constexpr units::meters_per_second_t kSpeedAt12Volts = 7_mps;
