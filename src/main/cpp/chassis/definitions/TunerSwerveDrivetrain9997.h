 ...
 */
class TunerSwerveDrive : public frc2::SubsystemBase, public TunerSwerveDrivetrain9997
// class TunerSwerveDrive : public TunerSwerveDrivetrain9997
{
...
public:
    ...
    TunerSwerveDrive(swerve::SwerveDrivetrainConstants const &driveTrainConstants, ModuleConstants const &...modules) : TunerSwerveDrivetrain9997{driveTrainConstants, modules...}
    {
    ...
    TunerSwerveDrive(
        ...
        ModuleConstants const &...modules) : TunerSwerveDrivetrain9997{driveTrainConstants, odometryUpdateFrequency, modules...}
    {
        if (utils::IsSimulation())
        {
            StartSimThread();
    ...
    TunerSwerveDrive(
        ...
        ModuleConstants const &...modules) : TunerSwerveDrivetrain9997{
    ...
    template <typename RequestSupplier>
        requires std::is_lvalue_reference_v<std::invoke_result_t<RequestSupplier>> &&
                 requires(RequestSupplier req, TunerSwerveDrivetrain9997 &drive) { drive.SetControl(req()); }
