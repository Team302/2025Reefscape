...
public:
    ...
    // This needs to be tuned to your individual robot
    static constexpr units::meters_per_second_t kSpeedAt12Volts = 6_mps;
...
public:
    ...
    /**
     * Creates a TunerSwerveDrive instance.
     * This should only be called once in your robot program.
     */
    static TunerSwerveDrive CreateDrivetrain();
};

/**
 * \brief Swerve Drive class utilizing CTR Electronics' Phoenix 6 API with the selected device types.
 */
class TunerSwerveDrivetrain9997 : public swerve::SwerveDrivetrain<hardware::TalonFX, hardware::TalonFX, hardware::CANcoder>
{
public:
    ...
    TunerSwerveDrivetrain9997(swerve::SwerveDrivetrainConstants const &driveTrainConstants, ModuleConstants const &...modules) : SwerveDrivetrain{driveTrainConstants, modules...}
    {
    }
